My test environment: **Centos 7** for clients op. system and **Puppet Enterprise 2015.3.2 edition** for Puppet server. On the Centos 7 client you **must enabled the epel repo**, because it need for nginx install!
